...
const Services = () => {
    return (
        <div className=' py-28 px-5 md:pl-20'>
            <h2 className=' text-transparent text-xl  mb-3 font-semibold mb-20 text-outline  opacity-30'>Services</h2>
            <h1 className='text-4xl font-bold text-white mb-4'>What I can offer</h1>
            <div className='grid grid-cols-1 md:grid-cols-2  mt-10 gap-10'>
                <div className='shadow-lg bg-indigo-900 rounded-2xl p-7 text-white hover:bg-transparent hover:drop-shadow-2xl hover:shadow-slate-800 duration-700 '>
